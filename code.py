...
import sys
dict=['add','00000','sub','00001','mul','00110','xor','01010','or','01011','and','01100','R1','001','R2','010','R3','011','R0','000','R4','100','R5','101','R6','110']

dict3=['ld','00100','st','00110','R1','001','R2','010','R3','011','R0','000','R4','100','R5','101','R6','110']

dict5=['jmp','01111','jlt','11100','jgt','11101','je','11111']
#f = open("cc.txt", "r")
l = []
dict4=['R1','001','R2','010','R3','011','R0','000','R4','100','R5','101','R6','110','mov','00010','ls','01001','rs','01000']
f=open("input.txt")
f1=f.readlines()
for i in f1:
    lk=i.rstrip().split()
    l.append(lk)
dict2=['mov','00011','div','00111','not','01101','cmp','01110','R1','001','R2','010','R3','011','R0','000','R4','100','R5','101','R6','110','FLAGS','111']
f.close()
o=[]
pp=[]
k=[]
